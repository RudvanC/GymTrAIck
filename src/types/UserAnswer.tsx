...
export interface UserAnswer {
  ...
  injuries: string; // Description of any injuries or physical limitations. Empty string if none.
  ...
  session_duration: string; // Preferred duration for a training session in minutes (e.g., "45"). Stored as string.
